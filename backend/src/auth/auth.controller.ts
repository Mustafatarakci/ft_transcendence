...
export class AuthController {
  ...
  @Get('oauthPage')
  @Redirect(
    'https://api.intra.42.fr/oauth/authorize?client_id=c44164aba01e6b4652fb6a4107e5188020a7e0c823b5013b2879b85ef7ea9abb&redirect_uri=http://localhost:3000/auth/getAccessToken&response_type=code',
  )
  async getOatuhPage() {
    return 'getOauthPage';
  }
  ...
  async getAccessToken(@Query('code') code) {
    ...
    const axiosResult = await axios({
      method: 'post',
      // url: `https://api.intra.42.fr/oauth/token?grant_type=authorization_code&client_id=c44164aba01e6b4652fb6a4107e5188020a7e0c823b5013b2879b85ef7ea9abb&client_secret=b3ee694a82c2014be143f7a31575cd6b15c3e7bf3fbf0ba7ca6de057e9f8673d&code=${code}`,
